...
uranus = sphere(pos=vector(urx,ury,0), radius=0.5,color=vector(.88,1,1),
	make_trail=True)
urpert = sphere(pos=vector(urx,ury,0), radius=0.5,color=vector(.88,1,1),
	make_trail=True)
...
for i in arange(0,1320):# estaba 1240
    rate(10)
    ...
    graphu.plot(i,deltaomgs*180/pi*3600)
    urpert.pos = r
